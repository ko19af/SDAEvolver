...
int main(int argc, char* argv[]) {
    ...
    for (int t = 0; t < 5; t++){
        ...
        to_string((int)hyperParameters[5]) + to_string((int)hyperParameters[6]) + to_string((double)hyperParameters[7]/100) + 
        to_string((int)hyperParameters[8]) + to_string((double)hyperParameters[9]/100) + to_string((int)hyperParameters[10]) + 
        to_string((int)hyperParameters[11]) + to_string(t) + ".txt";

        ofstream MyFile(fName);
        
        stringstream ss;
        ss << "# States: " << to_string((int)hyperParameters[0]) << " # Chars: " << to_string((int)hyperParameters[1])
        ...
        << " crossRate(%): " << setprecision(2) << ((double)hyperParameters[7])/100 << " mutationOperator: " << to_string((int)hyperParameters[8]) << " mutationRate(%): "
        << setprecision(2) << ((double)hyperParameters[9])/100 << " Heurestic: " << to_string((int)hyperParameters[11]) << " Topology: " << to_string(t) << " runs: " 
